...
export default function App({ navigation }) {
  ...
  const dataProduct = [
    { data:label: 'O', value: 120, color: '#5041cd' },
    { data:label: 'H', value: 80, color: '#63c380' },
    { data:label: 'MP', value: 100, color: '#e76e55' },
    { data:label: 'K', value: 60, color: '#f5a623' },
    { data:label: 'MZ', value: 76, color: '#9b59b6' },
  ];
