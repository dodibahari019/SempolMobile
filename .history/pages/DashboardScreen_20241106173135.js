...
export default function App({ navigation }) {
  ...
  const fetchData = async () => {
    try {
        const response = await axios.get('http://192.168.5.215/MyMobileProjectReal/sempolAPI/getDataDashboard.php');
...
const handleSubmit = () => {
  ...
  // Contoh POST ke API
  fetch('http://192.168.5.215/MyMobileProjectReal/sempolAPI/insertDataBaru.php', {
    method: 'POST',
    headers: {
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={{ backgroundColor:'#e8e7e7', borderRadius:30, bottom:0, display:'flex', marginTop:3 }}>
                <View style={[{backgroundColor:'#e8e7e7', height:65, marginHorizontal:5, marginVertical:5, borderRadius:30, display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center',}, {marginTop:10, borderWidth:1, borderColor:'#d9d9d9'}]}>
                    <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={() => fungsiTombol('Beranda')} style={{ backgroundColor: activeButton === 'Beranda' ? '#c08e78' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                    ...
                    <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={fungsiTombol.bind(this, 'NewData')} style={{ backgroundColor: activeButton === 'NewData' ? '#c08e78' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                     ...
                     <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={fungsiTombol.bind(this, 'Laporan')} style={{ backgroundColor: activeButton === 'Laporan' ? '#c08e78' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                    ...
                    <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={() => fungsiTombol('Setting')} style={{ backgroundColor: activeButton === 'Setting' ? '#c08e78' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                ...
                {isVisible == 'NewData' && (
                  <View>
                    <View style={{ borderWidth:0.5, display:'flex', flex:1, borderColor:'#afaeae', margin:10, paddingHorizontal:20, borderRadius:10, }}>
                        ...
                        <TouchableOpacity onPress={() => setShow(true)} style={{ marginTop:8, borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:8, paddingLeft:10, justifyContent:'space-between', flexDirection:'row'}}>
                        ...
                        <View>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
                              <TouchableOpacity onPress={showStartDatepicker}> 
                                <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 0.5, borderColor: '#afaeae', borderRadius: 10, padding: 10, marginRight: 10 }}>
                              ...
                              <TouchableOpacity onPress={showEndDatepicker}> 
                                <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 0.5, borderColor: '#afaeae', borderRadius: 10, padding: 10 }}>
                                  <Icon name="calendar" size={24} color="#000" />
                            ...
                            <TouchableOpacity onPress={handleExport} style={{ alignItems: 'center', borderWidth: 0.5, borderColor: '#afaeae', borderRadius: 10, padding: 10, flex: 1, marginRight: 5 }}>
                              <Icon name="file-pdf-o" size={24} color="#000" />
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity onPress={handleExport} style={{ alignItems: 'center', borderWidth: 0.5, borderColor: '#afaeae', borderRadius: 10, padding: 10, flex: 1, marginLeft: 5 }}>
                              <Icon name="file-excel-o" size={24} color="#000" />
                            </TouchableOpacity>
                          </View> 
                          </View>
                          </View>
                              <Text style={{fontFamily: 'HowdyLemon', color: '#545454', textAlign: 'right', marginRight:10, marginTop:10,}}>{date.toLocaleDateString()}</Text>
                        <View style={[{ marginVertical:10,  }, { borderWidth:0.5, borderColor:'#afaeae', elevation:10, fontWeight:'bold', backgroundColor:'#e8e7e7', borderRadius: 10, color:'#545454', padding:10}]}>
                            <View>
                                <TextInput style={{ justifyContent:'center', fontFamily:'HowdyLemon', fontSize:16, fontWeight:'600', alignItems:'center', textAlign:'center', borderColor:'#afaeae', borderWidth:0.5, borderRadius: 10, color:'#545454', padding:10, marginBottom:20}} value="Stock Awal" editable={false} />
                            </View>
