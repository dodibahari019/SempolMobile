                ...
                {isVisible == 'NewData' && (
                  <View>
                    <View style={{ borderWidth:0.5, display:'flex', flex:1, borderColor:'#afaeae', margin:10, paddingHorizontal:20, borderRadius:10, }}>
                        ...
                        <TouchableOpacity onPress={() => setShow(true)} style={{ marginTop:8, borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:8, paddingLeft:10, justifyContent:'', textAlign:'center', alignItems:'center'}}>
