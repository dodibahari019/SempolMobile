...
export default function App({ navigation }) {
  ...
  const dataProduct = [
    { data:'O',label: 'O', value: 120, color: '#5041cd' },
    { data:'O',label: 'H', value: 80, color: '#63c380' },
    { data:'O',label: 'MP', value: 100, color: '#e76e55' },
    { data:'O',label: 'K', value: 60, color: '#f5a623' },
    { data:'O',label: 'MZ', value: 76, color: '#9b59b6' },
  ];
