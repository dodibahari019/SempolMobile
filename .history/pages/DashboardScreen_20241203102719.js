            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <View>
                <View style={{backgroundColor:'#d9d9d9', padding:10,}}>
                  ...
                  <View style={{ marginTop:6, color:'#545454', padding:4, justifyContent:'space-between', flexDirection:'row'}}>
                      ...
                      <TouchableOpacity onPress={() => { setIsVisible('CreateNewLaporan'); setActiveButton('CreateNewLaporan'); navigation.navigate('CreateNewLaporan')}} style={{ backgroundColor: activeButton === 'CreateNewLaporan' ? '#545454' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                          <Ionicons name="cash-circle-outline" size={25} color= {activeButton === 'CreateNewLaporan' ? '#e8e7e7' : '#000000'} />
                        </Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  <View style={{ color:'#545454', padding:4, justifyContent:'space-between', flexDirection:'row'}}>
                      <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:12}}>Dari 5 Data Pengeluaran Pokok</Text>
                  </View>
                </View>
                <ScrollView style={{ display:'flex', flex:1, margin:10, padding:10, }}>
