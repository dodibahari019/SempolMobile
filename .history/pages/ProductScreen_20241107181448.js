...
const ProdukScreen = ({ navigation }) => {
    const produkKiri = [
        { nama: 'Original (O)', harga: '10000' },
        { nama: 'Jamur (J)', harga: '12000' },
        { nama: 'Hot Spicy (H)', harga: '13000' },
        { nama: 'Merah Putih (MP)', harga: '15000' },
        { nama: 'Kulit (K)', harga: '15000' },
    ];
                ...
                <View style={styles.tableRow}>
                    ...
                    {produkKiri[index + 1] && (
                        <TouchableOpacity style={styles.tableCellContainer} onPress={() => handleItemPress(produkKiri[index + 1])}>
                            ...
                            <Text style={styles.tableCell}>{produkKiri[index + 1].harga}</Text>
                        </TouchableOpacity>
                    )}
                </View>
            )
...
const styles = StyleSheet.create({
    ...
    buttonSave: {
        backgroundColor: '#545454', // Hijau limau
        padding: 10,
        borderRadius: 5,
        width: '45%',
    },
