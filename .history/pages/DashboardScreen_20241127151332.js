...
export default function App({ navigation }) {
  ...
  const dataProduct = [
    { data:'Oriinal',label: 'O', value: 120, color: '#5041cd' },
    { data:'Oriinal',label: 'H', value: 80, color: '#63c380' },
    { data:'Oriinal',label: 'MP', value: 100, color: '#e76e55' },
    { data:'Oriinal',label: 'K', value: 60, color: '#f5a623' },
    { data:'Oriinal',label: 'MZ', value: 76, color: '#9b59b6' },
  ];
