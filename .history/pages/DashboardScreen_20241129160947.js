            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <ScrollView>
                ...
                <View style={{ display:'flex', flex:1, margin:10, padding:10, }}>
                  ...
                  <View style={[{backgroundColor:'#FFF', height:50, width:'100%', marginVertical:5, marginTop:15, borderRadius:30, display:'flex', flexDirection:'row', justifyContent:'space-around', alignItems:'center',}, {marginTop:10, borderWidth:1, borderColor:'#d9d9d9'}]}>
                    <View style={{ display:'flex', flexDirection:'column', width:'50%', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity style={{ backgroundColor: activeButton === 'Beranda' ? '#545454' : '#e8e7e7', height:40, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'space-between', textAlign:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9', flexDirection:'row' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                          <Ionicons name="arrow-down-circle-outline" size={18} color= {activeButton === 'Beranda' ? '#e8e7e7' : '#000000'} />
                        </Text>
                    ...
                    <View style={{ display:'flex', flexDirection:'column', width:'50%', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity style={{ backgroundColor: activeButton === 'Beranda' ? '#545454' : '#e8e7e7', height:40, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'space-between', textAlign:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9', flexDirection:'row' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                          <Ionicons name="arrow-down-circle-outline" size={18} color= {activeButton === 'CreateNewLaporan' ? '#e8e7e7' : '#000000'} />
                        </Text>
                        <Text style={{ color:'#e8e7e7', fontWeight:'bold', fontFamily:'HowdyLemon', marginHorizontal:10}}>Pengeluaran</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  <TouchableOpacity style={{ marginTop:8, borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:5, paddingLeft:10, justifyContent:'space-between', flexDirection:'row'}}>
