            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <View>
                <View style={{backgroundColor:'#d9d9d9', padding:10,}}>
                  ...
                  <View style={{ borderWidth:1, borderColor:'#545453' marginTop:6, color:'#545454', padding:4, justifyContent:'space-between', alignContent:'center', alignItems:'center', flexDirection:'row'}}>
