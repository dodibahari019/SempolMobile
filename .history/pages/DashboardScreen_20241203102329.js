            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <View>
                <View style={{backgroundColor:'#d9d9d9', padding:10,}}>
                  ...
                  <TouchableOpacity style={{ marginTop:10, padding:4, justifyContent:'center',}}>
                    <Text style={{color:'#545454', fontWeight:'300', fontSize:14}}>Periode 1 Nov 2024 - 30 Nov 2024</Text>
                  </TouchableOpacity>
                  <View style={{ marginTop:8, color:'#545454', padding:4, paddingLeft:10, justifyContent:'space-between', flexDirection:'row'}}>
                      <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', padding:3, fontSize:20}}>Rp101.000</Text>
                      <Ionicons name="cash-outline" size={25} color={'#545454'} />
                  </View>
                </View>
