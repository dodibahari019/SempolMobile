                ...
                <View style={{ display:'flex', flex:1, margin:10, padding:10, }}>
                  ...
                  <View style={[{backgroundColor:'#FFF', height:50, marginHorizontal:5, marginVertical:5, borderRadius:30, display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center',}, {marginTop:10, borderWidth:1, borderColor:'#d9d9d9'}]}>
                    <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity style={{ backgroundColor: activeButton === 'Beranda' ? '#545454' : '#e8e7e7', height:40, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'space-between', textAlign:'' alignItems:'center', borderWidth:2, borderColor:'#d9d9d9', flexDirection:'row' }}>
