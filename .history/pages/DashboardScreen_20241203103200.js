              ...
              <View>
                <View style={{backgroundColor:'#d9d9d9', padding:10,}}>
                  ...
                  <TouchableOpacity style={{ marginTop:5, padding:4, justifyContent:'center',}}>
                    <Text style={{fontFamily:'HowdyLemon', color:'#545454', fontWeight:'100', fontSize:14}}>Periode 1 Nov 2024 - 30 Nov 2024</Text>
                  </TouchableOpacity>
                  <View style={{ marginTop:6, color:'#545454', padding:4, justifyContent:'space-between', alignContent:'center', alignItems:'center', flexDirection:'row'}}>
                      ...
                      <View style={{ backgroundColor: '#e8e7e7', height:40, width:40, borderRadius:30,paddingHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:0.8, borderColor:'#545454' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                          <Ionicons name="cash-outline" size={20} color= {'#545454'} />
                        </Text>
                      </View>
                  </View>
