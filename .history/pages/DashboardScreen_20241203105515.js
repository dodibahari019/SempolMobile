            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
                ...
                <ScrollView style={{ display:'flex', flex:1, margin:5, padding:8, }}>
                  ...
                  <View style={{ marginTop:20 }}>
                    ...
                    <View style={{ marginTop: 5, paddingVertical:10, display: 'flex', borderTopWidth: 0.3, borderColor: '#545454', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
