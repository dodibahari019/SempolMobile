                    ...
                    <View style={{ marginTop: 5, borderTopWidth: 0.3, borderColor: '#545454',  }}>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 16, fontWeight: '600', fontFamily: 'HowdyLemon' }}>120.000</Text>
                          </View>
                        </View>
                      </View>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 16, fontWeight: '600', fontFamily: 'HowdyLemon' }}>20.000</Text>
                          </View>
                        </View>
                      </View>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 16, fontWeight: '600', fontFamily: 'HowdyLemon' }}>10.000</Text>
                          </View>
                        </View>
                      </View>
                    </View>
