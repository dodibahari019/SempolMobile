            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <View>
                <View style={{backgroundColor:'#d9d9d9', padding:10,}}>
                  ...
                  <View style={{ borderWidth:1, borderColor:'#545454', borderRadius:10, marginTop:6, color:'#545454', padding:4, justifyContent:'space-between', alignContent:'center', alignItems:'center', flexDirection:'row'}}>
                      ...
                      <View style={{ backgroundColor: '#e8e7e7', height:50, width:50, borderRadius:30, justifyContent:'center', alignItems:'center', borderWidth:0.5, borderColor:'#545454' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                          <Ionicons name="cash-outline" size={25} color= {'#545454'} />
                        </Text>
                      </View>
