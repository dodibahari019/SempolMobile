...
const ProdukScreen = ({ navigation }) => {
    const produkKiri = [
        { nama: 'Sempol Balado', kategori: 'Kategori A', harga: '10000' },
        { nama: 'Sempol Jamur', kategori: 'Kategori B', harga: '12000' },
        { nama: 'Sempol Merah Putih', kategori: 'Kategori C', harga: '13000' },
        { nama: 'Sempol Hot Spicy', kategori: 'Kategori D', harga: '15000' },
    ];
