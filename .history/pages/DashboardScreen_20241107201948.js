                        ...
                        <View>
                            ...
                            <View>
                              <View style={{ flexDirection: 'column', justifyContent: 'space-between', marginBottom: 20 }}>
                                ...
                                <TouchableOpacity onPress={toggleModal} style={{ backgroundColor:'#545454', borderWidth:0.75, borderColor:'#afaeae', borderRadius:20, paddingVertical:10, paddingHorizontal:8, display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginVertical:10, }}>
                                    <Ionicons name="eye-outline" size={20} color="#FFF" />
