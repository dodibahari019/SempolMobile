...
export default function App({ navigation }) {
  ...
  const chartSize = width * 0.6; // Grafik akan menjadi 60% dari lebar layar
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={{ backgroundColor:'#d9d9d9', marginTop:20}}>
      ...
      style={{
        display: 'flex',
        flex: 1,
        height: width * 0.6, // Tinggi container mengikuti ukuran grafik
        marginTop: 8,
        borderWidth: 0.5,
        borderColor: '#afaeae',
        padding: 10,
      ...
      >
        ...
        <View
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: [{ translateX: -chartSize * 0.12 }, { translateY: -chartSize * 0.1 }],
            alignItems: 'center',
          }}
        >
