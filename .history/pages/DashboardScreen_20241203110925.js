...
export default function App({ navigation }) {
  ...
  isModalVisibleChartTwo, setModalVisibleChartTwo, 
  ...
  const fetchData = async () => {
    try {
        const response = await axios.get('http://192.168.248.215/SempolMobileApp/sempolAPI/getDataDashboard.php');
...
const handleSubmit = () => {
  ...
  // Contoh POST ke API
  fetch('http://192.168.248.215/SempolMobileApp/sempolAPI/insertDataBaru.php', {
    method: 'POST',
    headers: {
...
//Date Picker
  ...
  const toggleModalChartTwo = () => {
    setModalVisibleChartTwo(!isModalVisibleChartTwo);
  };
  ...
  const fungsiTombol = (valueData) => {
    if(valueData == 'Pemasukan'){
      setTypeButton('Pemasukan');
    }else if(valueData == 'Pengeluaran'){
      setTypeButton('Pengeluaran');
    }
  }
  ...
  return (
    <FrameDashboard navigation={navigation}>
      ...
      <ScrollView style={{ borderWidth:0.5, display:'flex', flex:1, borderColor:'#afaeae', margin:10, padding:20, borderRadius:10, }}>
          ...
          <Modal isVisible={isModalVisibleChartOne} style={{ justifyContent: 'flex-end', margin: 0 }}>
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <ScrollView>
                ...
                <View style={{ flex: 1, elevation:20, marginTop:-70, zIndex:1, backgroundColor:'#ededed', borderWidth:0, borderColor:'#d9d9d9', padding:5, margin:15, borderRadius:20 }}>
                  <View style={{ display:'flex', marginTop:25, marginBottom:15, flexDirection:'row', justifyContent:'space-around', alignItems:'center' }}>
                    <View style={{ display:'flex', flexDirection:'column' }}>
                        <View style={{ display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center' }}>
                          <Ionicons name="ellipse-outline" size={15} color="#188d00" />
                ...
                <View style={{ display:'flex', flex:1, margin:10, padding:10, }}>
                  ...
                  <View style={[{ backgroundColor: '#FFF', height: 50, width: '100%', marginVertical: 5, marginTop: 15, paddingHorizontal:5, borderRadius: 30, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'stretch', borderWidth: 1, borderColor: '#d9d9d9' }]}>
                    <View style={{ flexDirection: 'column', width: '50%', justifyContent: 'center', alignItems: 'center' }}>
                      <TouchableOpacity onPress={() => fungsiTombol("Pemasukan")} style={{ backgroundColor: typeButton === 'Pemasukan' ? '#545454' : '#FFF', height: 40, borderRadius: 30, paddingHorizontal: 10, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#d9d9d9', flexDirection: 'row', width: '100%' }}>
                    ...
                    <View style={{ flexDirection: 'column', width: '50%', justifyContent: 'center', alignItems: 'center' }}>
                      <TouchableOpacity onPress={() => fungsiTombol("Pengeluaran")} style={{ backgroundColor: typeButton === 'Pengeluaran' ? '#545454' : '#FFF', height: 40, borderRadius: 30, paddingHorizontal: 10, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#d9d9d9', flexDirection: 'row', width: '100%' }}>
                        <Text style={{ color: '#000000', fontWeight: 'bold' }}>
                  ...
                  {typeButton == 'Pemasukan' && (
                    <View>
                      <TouchableOpacity style={{ marginTop: 10, display: 'flex', borderWidth: 0.3, borderRadius:10, borderColor: '#545454', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Ionicons name="cash-outline" size={25} color={'#545454'} />
                          </View>
                          <View style={{ display: 'flex', flexDirection: 'column', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>Cash</Text>
                            <Text style={{ fontSize: 12, fontWeight: '600', fontFamily: 'HowdyLemon', color:'#555' }}>510.000</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 16, fontWeight: '600', fontFamily: 'HowdyLemon' }}>55%</Text>
                          </View>
                          <TouchableOpacity style={{ marginLeft: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Ionicons name="chevron-forward-outline" size={25} color={'#545454'} />
                          </TouchableOpacity>
                        </View>
                      </TouchableOpacity>
                      <TouchableOpacity style={{ marginTop: 10, display: 'flex', borderWidth: 0.3, borderRadius:10, borderColor: '#545454', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Ionicons name="card-outline" size={25} color={'#545454'} />
                          </View>
                          <View style={{ display: 'flex', flexDirection: 'column', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>QRIS</Text>
                            <Text style={{ fontSize: 12, fontWeight: '600', fontFamily: 'HowdyLemon', color:'#555' }}>210.000</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 16, fontWeight: '600', fontFamily: 'HowdyLemon' }}>27%</Text>
                          </View>
                          <TouchableOpacity style={{ marginLeft: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Ionicons name="chevron-forward-outline" size={25} color={'#545454'} />
                          </TouchableOpacity>
                      ...
                      <TouchableOpacity style={{ marginTop: 10, display: 'flex', borderWidth: 0.3, borderRadius:10, borderColor: '#545454', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Ionicons name="restaurant-outline" size={25} color={'#545454'} />
                          </View>
                          <View style={{ display: 'flex', flexDirection: 'column', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>GoFood</Text>
                            <Text style={{ fontSize: 12, fontWeight: '600', fontFamily: 'HowdyLemon', color:'#555' }}>210.000</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 16, fontWeight: '600', fontFamily: 'HowdyLemon' }}>18%</Text>
                          </View>
                  ...
                  {typeButton == 'Pengeluaran' && (
                    <View>
                      <View style={{ marginTop: 10, display: 'flex', borderWidth: 0.3, borderRadius:10, borderColor: '#545454', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <TouchableOpacity onPress={toggleModalChartTwo} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Ionicons name="cash-outline" size={25} color={'#545454'} />
                          </View>
                          <View style={{ display: 'flex', flexDirection: 'column', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>Pengeluaran Pokok</Text>
                            <Text style={{ fontSize: 12, fontWeight: '600', fontFamily: 'HowdyLemon', color:'#555' }}>510.000</Text>
                          </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={toggleModalChartTwo} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                      ...
                      <TouchableOpacity style={{ marginTop: 10, display: 'flex', borderWidth: 0.3, borderRadius:10, borderColor: '#545454', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
                          ...
                          <View style={{ display: 'flex', flexDirection: 'column', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>Biaya Operasional</Text>
                            <Text style={{ fontSize: 12, fontWeight: '600', fontFamily: 'HowdyLemon', color:'#555' }}>210.000</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 10, paddingVertical:15 }}>
          ...
          {/* MODAL DETAIL*/}
          <Modal isVisible={isModalVisibleChartTwo} style={{ justifyContent: 'flex-end', margin: 0 }}>
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
                <View style={{backgroundColor:'#d9d9d9', padding:10,}}>
                  <View style={{ display:'flex', flexDirection:'row', justifyContent:'flex-start', alignItems:'center', alignContent:'center' }}>
                    <TouchableOpacity onPress={toggleModalChartTwo} style={{ justifyContent:'center', alignItems:'center'}}>
                      <Ionicons name="chevron-back-outline" size={25} color="#545454" />
                    </TouchableOpacity>
                    <TouchableOpacity style={{ padding:6, justifyContent:'center', alignItems:'center'}}>
                      <Text style={{fontFamily:'HowdyLemon', color:'#545454', padding:5, textAlign:'center', fontSize:18}}>Pengeluaran Pokok</Text>
                    </TouchableOpacity>
                  </View>
                  <TouchableOpacity style={{ marginTop:5, padding:4, justifyContent:'center',}}>
                    <Text style={{fontFamily:'HowdyLemon', color:'#545454', fontWeight:'100', fontSize:12}}>Periode 1 Nov 2024 - 30 Nov 2024</Text>
                  </TouchableOpacity>
                  <View style={{ marginTop:6, color:'#545454', padding:4, justifyContent:'space-between', alignContent:'center', alignItems:'center', flexDirection:'row'}}>
                      <View style={{ display:'flex', flex:1, flexDirection:'column', justifyContent:'center', }}>
                        <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:20}}>Rp101.000</Text>
                        <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:12}}>Dari 5 Data Pengeluaran Pokok</Text>
                      </View>
                      <View style={{ backgroundColor: '#e8e7e7', height:45, width:45, borderRadius:30, justifyContent:'center', alignItems:'center', borderWidth:0.5, borderColor:'#545454' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                          <Ionicons name="cash-outline" size={25} color= {'#545454'} />
                        </Text>
                      </View>
                ...
                <ScrollView style={{ display:'flex', flex:1, margin:5, padding:8, marginBottom:50}}>
                  <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:16}}>Daftar Data : </Text>           
                  <View style={{ marginTop:20, borderWidth:0.5, borderColor:'#545454', borderRadius:5, padding:5 }}>
                    <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:14, paddingVertical:5,}}>01 November 2024</Text>           
                    <View style={{ marginTop: 5, borderTopWidth: 0.3, borderColor: '#545454',  }}>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Ionicons name="cash-outline" size={25} color={'#545454'} />
                          </View>
                          <View style={{ display: 'flex', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>Gaji</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>120.000</Text>
                          </View>
                        </View>
                      </View>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                          ...
                          <View style={{ display: 'flex', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>Bensin</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>20.000</Text>
                          </View>
                        </View>
                      </View>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                          ...
                          <View style={{ display: 'flex', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>Bonus</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>10.000</Text>
                          </View>
                        </View>
                      </View>
                    </View>
                    <View style={{ marginTop: 10, borderTopWidth: 0.3, borderColor: '#545454',  }}>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', marginLeft: 5, justifyContent: 'center', alignItems: 'flex-start' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>Total</Text>
                          </View>
                        </View>
                        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ display: 'flex', flexDirection: 'column', marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 14, fontWeight: '600', fontFamily: 'HowdyLemon' }}>150.000</Text>
                          </View>
                        </View>
                      </View>
                    </View>
                  ...
                  <View style={{ marginTop:20, borderWidth:0.5, borderColor:'#545454', borderRadius:5, padding:5 }}>
                    <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:14, paddingVertical:5,}}>02 November 2024</Text>           
                    <View style={{ marginTop: 5, borderTopWidth: 0.3, borderColor: '#545454',  }}>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                  ...
                  <View style={{ marginTop:20, borderWidth:0.5, borderColor:'#545454', borderRadius:5, padding:5 }}>
                    <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:14, paddingVertical:5,}}>03 November 2024</Text>           
                    <View style={{ marginTop: 5, borderTopWidth: 0.3, borderColor: '#545454',  }}>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
                  ...
                  <View style={{ marginTop:20, borderWidth:0.5, borderColor:'#545454', borderRadius:5, padding:5 }}>
                    <Text style={{fontFamily:'HowdyLemon', flex:1, color:'#545454', fontSize:14, paddingVertical:5,}}>04 November 2024</Text>           
                    <View style={{ marginTop: 5, borderTopWidth: 0.3, borderColor: '#545454',  }}>
                      <View style={{ paddingTop:8, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                          <View style={{ marginRight: 5, justifyContent: 'center', alignItems: 'center' }}>
