                        ...
                        <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
                          <ScrollView>
                            <View style={{backgroundColor:'#cfcfcf', padding:10,}}>
                              <View style={{ display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'flex-start', alignContent:'center' }}>
                                ...
                                <TouchableOpacity style={{ padding:6, justifyContent:'center', alignItems:'center'}}>
                                  <Text style={{fontFamily:'HowdyLemon', color:'#545454', padding:5, textAlign:'center', fontSize:16}}>Rekap Keuanganmu</Text>
                                </TouchableOpacity>
                              </View>
