            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <ScrollView>
                ...
                <View style={{ display:'flex', flex:1, margin:10, padding:10, }}>
                  ...
                  <View style={[{backgroundColor:'#FFF', height:50, marginVertical:5, marginTop:15, borderRadius:30, display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center',}, {marginTop:10, borderWidth:1, borderColor:'#d9d9d9'}]}>
