            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
              <ScrollView>
                ...
                <View style={{ display:'flex', flex:1, margin:10, padding:10, }}>
                  ...
                  <View style={{ marginTop:20, diplay:'flex', borderWidth:0.5, borderColor: '#545454', flexDirection:'row', justifyContent:'space-between', alignItems:'center', alignContent:'center' }}>
                    <View style={{ diplay:'flex', flexDirection:'row', justifyContent:'space-between', padding:5, alignItems:'center', alignContent:'center' }}>
                      <View style={{ marginRight:5, justifyContent:'center', alignItems:'center', textAlign:'center' }}>
                        <Ionicons name="qr-code-outline" size={20} color={typeButton === 'Pengeluaran' ? '#FFF' : '#545454'} />
                      </View>
                      <View style={{ display:'flex', flexDirection:'column', marginLeft:5, justifyContent:'center', alignItems:'flex-start', textAlign:'center' }}>
                        <Text style={{ fontSize: 14, marginTop: 10, fontWeight: '600', fontFamily:'HowdyLemon', }}>QRIS</Text>
                        <Text style={{ fontSize: 12, marginTop: 10, fontWeight: '600', fontFamily:'HowdyLemon', }}>210.000</Text>
                      </View>
                    </View>
                    <View style={{ diplay:'flex', flexDirection:'row', justifyContent:'center', padding:5, alignItems:'center', alignContent:'center' }}>
                      <View style={{ display:'flex', flexDirection:'column', marginRight:5, justifyContent:'center', alignItems:'center', textAlign:'center' }}>
                        <Text style={{ fontSize: 16, marginTop: 10, fontWeight: '600', fontFamily:'HowdyLemon', }}>37%</Text>
                      </View>
                      <View style={{ marginLeft:5, justifyContent:'center', alignItems:'center', textAlign:'center' }}>
                        <Ionicons name="chevron-forward-outline" size={25} color={typeButton === 'Pengeluaran' ? '#FFF' : '#545454'} />
                      </View>
                    </View>
                  </View>
                  <TouchableOpacity style={{ marginTop:8, borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:5, paddingLeft:10, justifyContent:'space-between', flexDirection:'row'}}>
