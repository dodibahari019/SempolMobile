                  ...
                  <ScrollView style={{ borderWidth:0.5, display:'flex', flex:1, borderColor:'#afaeae', margin:10, padding:20, borderRadius:10, }}>
                      ...
                      <Modal isVisible={isModalVisibleChartOne} style={{ justifyContent: 'flex-end', margin: 0 }}>
                        <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
                          <ScrollView>
                            <View style={{backgroundColor:'#cfcfcf', padding:10,}}>
                              <View style={{ display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center', alignContent:'flex-start' }}>
                                <TouchableOpacity onPress={toggleModalChartOne} style={{ padding:6, justifyContent:'center', alignItems:'center'}}>
                                  <Ionicons name="chevron-back-outline" size={20} color="#545454" />
                                </TouchableOpacity>
                                <TouchableOpacity style={{ padding:6, justifyContent:'center', alignItems:'center'}}>
                                  <Text style={{fontFamily:'HowdyLemon', color:'#545454', padding:5, textAlign:'center', fontSize:15}}>Rekap Keuanganmu</Text>
                                </TouchableOpacity>
                              </View>
                              ...
                              <View style={{ marginTop:8, marginBottom:20, borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:8, paddingLeft:10, justifyContent:'space-between', flexDirection:'row'}}>
