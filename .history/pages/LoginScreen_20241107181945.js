    ...
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.inputContainer}>
          <Icon name="envelope" size={24} color="#545454" style={styles.icon} />
          <TextInput style={styles.input} placeholder="Email" placeholderTextColor="#888" />
        </View>

        <View style={styles.inputContainer}>
          <Icon name="lock" size={33} color="#545454" style={styles.icon} />
          <TextInput
            style={styles.input}
          ...
          <TouchableOpacity onPress={() => setPasswordVisible(!passwordVisible)}>
            <Icon name={passwordVisible ? "eye" : "eye-slash"} size={24} color="#545454" style={styles.icon} />
          </TouchableOpacity>
        </View>
