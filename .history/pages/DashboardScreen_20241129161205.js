...
//Date Picker
  ...
  display: 'flex', 
  flexDirection: 'row', 
  justifyContent: 'space-between', // Menggunakan space-between untuk memberi jarak antar elemen
  alignItems: 'stretch', // Membuat kedua elemen mengambil seluruh lebar yang tersedia
  borderWidth: 1, 
  borderColor: '#d9d9d9'
}]}>
  <View style={{ 
    ...
    <TouchableOpacity style={{
      backgroundColor: activeButton === 'Beranda' ? '#545454' : '#e8e7e7',
      height: 40, 
      borderRadius: 30,
      ...
      borderColor: '#d9d9d9',
      flexDirection: 'row',
      width: '100%' // Pastikan tombol mengambil lebar penuh dari 50%
    }}>
