              ...
              <View>
                <View style={{backgroundColor:'#d9d9d9', padding:10,}}>
                  ...
                  <View style={{ marginTop:6, color:'#545454', padding:4, justifyContent:'space-between', flexDirection:'row'}}>
                      ...
                      <View style={{ backgroundColor: '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:0, borderColor:'#545454' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                          <Ionicons name="cash-outline" size={25} color= {'#545454'} />
                        </Text>
                      </View>
