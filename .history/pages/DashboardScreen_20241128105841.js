...
export default function App({ navigation }) {
  ...
  const fetchData = async () => {
    try {
        const response = await axios.get('http://        const response = await axios.get('http:///SempolMobileApp/sempolAPI/getDataDashboard.php');/SempolMobileApp/sempolAPI/getDataDashboard.php');
...
const handleSubmit = () => {
  ...
  // Contoh POST ke API
  fetch('http://  fetch('http:///SempolMobileApp/sempolAPI/insertDataBaru.php', {/SempolMobileApp/sempolAPI/insertDataBaru.php', {
    method: 'POST',
    headers: {
