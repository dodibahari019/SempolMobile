                        ...
                        <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
                          <ScrollView>
                            <View style={{backgroundColor:'#cfcfcf', padding:10,}}>
                              ...
                              <View style={{ marginTop:8, marginb borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:8, paddingLeft:10, justifyContent:'space-between', flexDirection:'row'}}>
