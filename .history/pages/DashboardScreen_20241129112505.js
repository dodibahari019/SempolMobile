                        ...
                        <View style={{ backgroundColor: 'white', borderRadius: 10, height: height,}}>
                          <ScrollView>
                            <View style={{backgroundColor:'#cfcfcf', padding:10,}}>
                              <TouchableOpacity style={{ borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:6, justifyContent:'center', alignItems:'center'}}>
                                <Text style={{fontFamily:'HowdyLemon', color:'#545454', padding:5, textAlign:'center'}}>Rekap Keuanganmu</Text>
                              </TouchableOpacity>
                              <TouchableOpacity style={{ marginTop:10, borderWidth:0.5, borderColor:'#afaeae', borderRadius: 10, color:'#545454', padding:6, justifyContent:'center',}}>
                                <Text style={{fontFamily:'HowdyLemon', color:'#545454', padding:5,}}>Semua Pemasukan & Pengeluaran</Text>
                              </TouchableOpacity>
