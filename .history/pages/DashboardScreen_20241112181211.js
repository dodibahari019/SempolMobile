...
export default function App({ navigation }) {
  ...
  const fetchData = async () => {
    try {
        const response = await axios.get('http://192.168.141.215192.168.141.215192.168.141.215192.168.141.215192.168.141.215192.168.141.215/MyMobileProjectReal/sempolAPI/getDataDashboard.php');
...
const handleSubmit = () => {
  ...
  // Contoh POST ke API
  fetch('http://192.168.141.215192.168.141.215192.168.141.215192.168.141.215192.168.141.215192.168.141.215/MyMobileProjectReal/sempolAPI/insertDataBaru.php', {
    method: 'POST',
    headers: {
