            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={{ backgroundColor:'#e8e7e7', borderRadius:30, bottom:0, display:'flex', marginTop:3 }}>
                <View style={[{backgroundColor:'#e8e7e7', height:65, marginHorizontal:5, marginVertical:5, borderRadius:30, display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center',}, {marginTop:10, borderWidth:1, borderColor:'#d9d9d9'}]}>
                    <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={() => fungsiTombol('Beranda')} style={{ backgroundColor: activeButton === 'Beranda' ? '#pages/DashboardScreen.js' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                    ...
                    <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={fungsiTombol.bind(this, 'NewData')} style={{ backgroundColor: activeButton === 'NewData' ? '#pages/DashboardScreen.js' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                     ...
                     <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={fungsiTombol.bind(this, 'Laporan')} style={{ backgroundColor: activeButton === 'Laporan' ? '#pages/DashboardScreen.js' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                    ...
                    <View style={{ display:'flex', flexDirection:'column', justifyContent:'space-between', alignItems:'center' }}>
                      <TouchableOpacity onPress={() => fungsiTombol('Setting')} style={{ backgroundColor: activeButton === 'Setting' ? '#pages/DashboardScreen.js' : '#e8e7e7', height:50, width:50, borderRadius:30,paddingHorizontal:10, marginHorizontal:10, justifyContent:'center', alignItems:'center', borderWidth:2, borderColor:'#d9d9d9' }}>
                        <Text style={{ color:'#000000', fontWeight:'bold' }}>
                ...
                {isVisible == 'NewData' && (
                  <View>
                    <View style={{ borderWidth:0.5, display:'flex', flex:1, borderColor:'#afaeae', margin:10, paddingHorizontal:20, borderRadius:10, }}>
                        ...
                        <TouchableOpacity onPress={toggleModal} style={{ backgroundColor:'#pages/DashboardScreen.js', borderWidth:0.75, borderColor:'#afaeae', borderRadius:20, paddingVertical:10, paddingHorizontal:8, display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginVertical:20, }}>
                        ...
                        <Modal isVisible={isModalVisible} style={{ justifyContent: 'flex-end', margin: 0 }}>
                          <View style={{ backgroundColor: 'white', borderRadius: 10, padding: 10, height: height,}}>
                            ...
                            <View style={{ flexDirection:'row', justifyContent:'space-between', bottom:0, width:'100%', }}>
                              <TouchableOpacity onPress={handleSubmit} style={{ backgroundColor:'#pages/DashboardScreen.js', marginRight:5, flex:1, borderWidth:0.75, borderColor:'#afaeae', borderRadius:20, paddingVertical:10, paddingHorizontal:8, flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginVertical:10, }}>
                                  <Ionicons name="add-circle-outline" size={20} color="#FFF" />
                                  <Text style={{ color:'#FFF', fontWeight:'600',fontFamily:'HowdyLemon', marginHorizontal:10, fontSize:12, }}>Simpan</Text>
                              </TouchableOpacity>
                              <TouchableOpacity onPress={toggleModal} style={{ backgroundColor:'#FFF', marginLeft:5, flex:1, borderWidth:0.75, borderColor:'#pages/DashboardScreen.js', borderRadius:20, paddingVertical:10, paddingHorizontal:8, flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginVertical:10, }}>
                                <Ionicons name="close-circle-outline" size={20} color="#pages/DashboardScreen.js" />
                                <Text style={{ color:'#pages/DashboardScreen.js', fontWeight:'600',fontFamily:'HowdyLemon', marginHorizontal:10, fontSize:12, }}>Cancel</Text>
                              </TouchableOpacity>
                            </View>
                          </View>
                        </Modal>
                ...
                {isVisible == 'Laporan' && (
                  <View style={{ borderWidth:0.5, display:'flex', flex:1, borderColor:'#afaeae', margin:10, paddingHorizontal:20, borderRadius:10, }}>
                        ...
                        <TouchableOpacity style={{ backgroundColor:'#pages/DashboardScreen.js', borderWidth:0.75, borderColor:'#afaeae', borderRadius:20, paddingVertical:10, paddingHorizontal:8, display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginVertical:20, }}>
                            <Ionicons name="add-circle-outline" size={20} color="#FFF" />
                            <Text style={{ color:'#FFF', fontWeight:'600',fontFamily:'HowdyLemon', marginHorizontal:10, fontSize:12, }}>Simpan</Text>
                        </TouchableOpacity>
                  </View>
                ...
                {isVisible == 'Setting' && (
                  <View style={{ borderWidth:0.5, display:'flex', flex:1, borderColor:'#afaeae', margin:10, paddingHorizontal:20, borderRadius:10, }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Product')} style={{display:'flex', flex:1, borderColor:'#pages/DashboardScreen.js', borderWidth:1, marginTop:10, justifyContent:'center', alignItems:'center', borderRadius:10,}}>
                      <Ionicons name="cart-outline" size={40} color="#pages/DashboardScreen.js" />
                      <Text style={{ color:'#pages/DashboardScreen.js', fontWeight:'600',fontFamily:'HowdyLemon', marginHorizontal:10, fontSize:15, }}>Product</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('Users')} style={{display:'flex', flex:1, borderColor:'#pages/DashboardScreen.js', borderWidth:1, marginTop:10, marginBottom:30, justifyContent:'center', alignItems:'center', borderRadius:10,}}>
                      <Ionicons name="people-outline" size={40} color="#pages/DashboardScreen.js" />
                      <Text style={{ color:'#pages/DashboardScreen.js', fontWeight:'600',fontFamily:'HowdyLemon', marginHorizontal:10, fontSize:15, }}>User</Text>
                    </TouchableOpacity>
                  </View>
                )}
            </ScrollView>
