                ...
                <View style={{ display:'flex', flex:1, margin:10, padding:10, }}>
                  ...
                  <View style={{ diplay:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'stretch', alignContent:'center' }}>
                    <View style={{ diplay:'flex', flexDirection:'row', justifyContent:'space-between', padding:5, alignItems:'stretch', alignContent:'center' }}>
                      <View style={{ marginHorizontal:5, justifyContent:'center', alignItems:'center', textAlign:'center' }}>
                        <Ionicons name="arrow-up-circle-outline" size={18} color={typeButton === 'Pengeluaran' ? '#FFF' : '#545454'} />
                      </View>
                      <View style={{ display:'flex', flexDirection:'column', marginHorizontal:5, justifyContent:'center', alignItems:'flex-start', textAlign:'center' }}>
