    ...
    <AppProvider>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Login">
          ...
          <Stack.Screen name="Laporan" options={{ headerShown: false }} component={DashboardScreen} />
          <Stack.Screen name="Setting" options={{ headerShown: false }} component={DashboardScreen} />
